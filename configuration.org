...
#+begin_src emacs-lisp
  ...
  ;; (custom-set-faces
  ;;  '(tab-bar ((t (:background "#202020" :foreground "#fff" :height 1 :padding 1))))
  ;;  '(tab-bar-tab ((t (:background "#202020" :foreground "#fff" :box (:line-width 3 :color "#191919" :style flat-button)))))
  ;;  '(tab-bar-tab-inactive ((t (:background "#202020" :foreground "#aaa")))))
